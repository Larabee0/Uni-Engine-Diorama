...
public partial class MeshAreaSystem : SystemBase
{
    ...
    private void RunTriangulator(EntityCommandBuffer.ParallelWriter ecbEnd)
    {
    ...
    private void OnTriangulatorComplete(EntityCommandBuffer.ParallelWriter ecbEnd)
    {
