...
{
    public static JobHandle Erode(NativeArray<HeightMapElement> heightMap,int numErosionIterations, ErodeSettings settings, JobHandle dependency)
    {
        ...
        return erodeJob.Schedule(numErosionIterations, 64, dependency);
    }
}
